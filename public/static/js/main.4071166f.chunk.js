        ...
        572: function(e, t, a) {
            ...
            var P = function(e) {
                    function t() {
                        ...
                        return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(i)))).count = 0, a.lastInBytes = 0, a.lastOtBytes = 0, a.state = {
                    ...
                    return Object(m.a)(t, e), Object(d.a)(t, [{
                        ...
                        value: function() {
                            ...
                            }, i.a.createElement(b.a, null, i.a.createElement(M.a, {
                                echarts: S.a,
                                ref: "echarts_react",
                ...
                D = function(e) {
                    function t() {
                        ...
                        Object(c.a)(this, t);
                        for (var n = arguments.length, i = new Array(n), r = 0; r < n; r++) i[r] = arguments[r];
                        return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(i)))).state = {
                            data: [],
                            loading: !1
                        }, a.fetch = function() {
                            a.setState({
                    ...
                    return Object(m.a)(t, e), Object(d.a)(t, [{
                        ...
                        value: function() {
                            return i.a.createElement(b.a, {
                                title: i.a.createElement(n.Fragment, null, i.a.createElement(l.a, {
                                    type: "hdd"
                ...
                z = function(e) {
                    ...
                    return Object(m.a)(t, e), Object(d.a)(t, [{
                        key: "componentWillUnmount",
                        value: function() {
                            this.flvPlayer && (this.flvPlayer.unload(), this.flvPlayer.detachMediaElement(), this.flvPlayer.destroy())
                        }
                    }, {
                        key: "render",
                        value: function() {
                ...
                G = function(e) {
                    function t() {
                        ...
                        return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(r)))).cookies = new H.a, a.state = {
                            streamsData: [],
                            loading: !1,
                            visible: !1,
                            password: ""
                        ...
                        },
                        {
                            ...
                            a.videoModal = U.a.info({
                                ...
                                content: i.a.createElement(z, {
                                    url: "/".concat(e.app, "/").concat(e.name, ".flv").concat(t),
                                    type: "flv"
                                })
                            })
                        }, a.fetch = function() {
                                        ...
                                        if (o) {
                                            var l = (new Date).getTime() / 1e3,
                                                ...
                                                d = {
                                                    key: n++,
                                                    app: i,
                                                    link: `${window.location.hostname}/live/${r}.flv`,
                                                    name: r,
                                                    id: o.clientId,
                                                    ip: o.ip,
                                                    ac: o.audio ? o.audio.codec + " " + o.audio.profile : "",
                                                    freq: o.audio ? o.audio.samplerate : "",
                                                    chan: o.audio ? o.audio.channels : "",
                                                    vc: o.video ? o.video.codec + " " + o.video.profile : "",
                                                    size: o.video ? o.video.width + "x" + o.video.height : "",
                    ...
                    return Object(m.a)(t, e), Object(d.a)(t, [{
                        ...
                        key: "render",
                        value: function() {
                            return i.a.createElement(b.a, null, i.a.createElement(T.a.Password, {
                                size: "large",
                ...
                J = function(e) {
                    function t() {
                        ...
                        Object(c.a)(this, t);
                        for (var n = arguments.length, i = new Array(n), r = 0; r < n; r++) i[r] = arguments[r];
                        return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(i)))).fullTitle = "Shaw Media Server", a.shortTitle = "SMS", a.state = {
                            collapsed: !1,
                            title: a.fullTitle,
                            pathname: "/"
                        }, a.toggle = function() {
                    ...
                    return Object(m.a)(t, e), Object(d.a)(t, [{
                        ...
                        key: "render",
                        value: function() {
                            return i.a.createElement(f.a, null, i.a.createElement(h.a, {
                                style: {
                                    minHeight: "100vh"
                                }
                            }, i.a.createElement(W, {
                                ...
                                className: "logo"
                            }, i.a.createElement("h1", null, this.state.title)), i.a.createElement(s.b, {
                                theme: "dark",
                                mode: "inline",
                                defaultSelectedKeys: [Object(g.a)().location.pathname]
                            }, i.a.createElement(s.b.Item, {
                                key: "/admin/"
                            }, i.a.createElement(f.b, {
                                to: "/admin/"
                            }, i.a.createElement(l.a, {
                                type: "dashboard"
                            }), i.a.createElement("span", null, "Dashboard"))), i.a.createElement(s.b.Item, {
                                key: "/admin/streams"
                            }, i.a.createElement(f.b, {
                                to: "/admin/streams"
                            }, i.a.createElement(l.a, {
                                type: "video-camera"
                            }), i.a.createElement("span", null, "Streams"))), i.a.createElement(s.b.Item, {
                                key: "/admin/profile"
                            }, i.a.createElement(f.b, {
                                to: "/admin/profile"
                            }, i.a.createElement(l.a, {
                                type: "profile"
                            }), i.a.createElement("span", null, "Profile"))))), i.a.createElement(h.a, null, i.a.createElement(V, {
                                style: {
                                    background: "#fff",
                                    padding: 0
                                }
